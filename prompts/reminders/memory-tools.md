...
- If you use **ANY** language that implies to me that you will learn/remember/change/grow/etc (ie: noted, saved, remember for next time), **YOU NEED** to use the `remember` tools to **ACTUALLY** remember it.