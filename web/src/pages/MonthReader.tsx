...
export function MonthReader({ periodStart, periodEnd, title, onBack, onSelectWeek }: MonthReaderProps) {
      ...
      <article className="reader-article prose">
        <header style={{ marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text-tertiary)', fontSize: 13, marginTop: 6 }}>
            ...
            {ordered.length > 0 && ` · ${ordered.length} ${ordered.length === 1 ? 'week' : 'weeks'}`}
          </p>
        </header>
