...
from charlieverse.server.middleware.meta import MetaMiddleware
...
async def start_server(host: str, port: int):
    ...
    # Middleware
    # mcp.add_middleware(CharlieverseErrorMiddleware(include_traceback=False, transform_errors=True))
    mcp.add_middleware(MetaMiddleware())
