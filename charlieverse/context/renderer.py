...
class ActivationContextRenderer:
    ...
    def _render_sessions(self) -> None:
        ...
        for session in self.bundle.recent_sessions:
            ...
            self.append(f'<session time="{relative_date(session.updated_at)}"{path}{most_recent_attr}>')
    ...
    def append_entity(self, entity: Entity):
        ...
        attrs = f't="{relative_date(entity.updated_at)}"'
    ...
    def _render_messages(self) -> None:
        ...
        for msg in messages:
            ...
            self.append(f'<{label} t="{age}">{content}</{label}>')
